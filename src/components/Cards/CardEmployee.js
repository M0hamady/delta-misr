          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap justify-center text-center mb-24">
              <div className="w-full lg:w-6/12 px-4">
                <h2 className="text-4xl font-semibold">Our groube</h2>
                <p className="text-lg leading-relaxed m-4 text-blueGray-500">
                  we are so proud of our team, becouse they are working togeather to make you happy.
                </p>
              </div>
            </div>
            <div className="flex flex-wrap">
              <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4 hover:shadow-lg ease-linear transition-all duration-150 rounded-lg">
                <div className="px-6">
                  ...
                  <div className="pt-6 text-center">
                    <h5 className="text-xl font-bold">Mohamed aAtef</h5>
              ...
              <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4 hover:shadow-lg ease-linear transition-all duration-150 rounded-lg">
                <div className="px-6">
                  ...
                  />
                  <div className="pt-6 text-center">
                    <h5 className="text-xl font-bold">Eslam Mohamed</h5>
                    <p className="mt-1 text-sm text-blueGray-400 uppercase font-semibold">
                    Team Leader
                    </p>
                    <div className="mt-6">
              ...
              <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4 hover:shadow-lg ease-linear transition-all duration-150 rounded-lg">
                <div className="px-6">
                  ...
                  />
                  <div className="pt-6 text-center">
                    <h5 className="text-xl font-bold">Mohamed mohamed</h5>
                    <p className="mt-1 text-sm text-blueGray-400 uppercase font-semibold">
                      Economic
                    </p>
                    <div className="mt-6">
              ...
              <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4 hover:shadow-lg ease-linear transition-all duration-150 rounded-lg">
                <div className="px-6">
                  ...
                  />
                  <div className="pt-6 text-center">
                    <h5 className="text-xl font-bold ">mohamed atef</h5>
                    <p className="mt-1 text-sm text-blueGray-400 uppercase font-semibold">
                      Sales manager
                    </p>
                    <div
